...
## <a name='Installing'></a> :rocket: Installing Harunoie

To install Harunoie in your local machine, follow this instructions
...
```sh
git clone -b <your_branch> https://github.com/bpoc-mark/harunoie.git
```

After cloning, open your wordpress dashboard and activate the theme.

## <a name='Usage'></a>:computer: Usage of Harunoie
