        ...
        <div class="heat">
            ...
            <div class="heat__col-2">
                ...
                <p class="seismic_grade">
                    震度7の大地震で倒壊しないなら、『耐震等級1』で十分と考える方もいらっしゃるかもしれません。
                    しかし、2016年の熊本地震では繰り返す揺れによって『耐震等級2』の住宅が倒壊しています。
                    これにより、『耐震等級1』はあくまでも避難時間をかせぐための耐震性能に過ぎず、その後も住み続ける上では、強度として十分でないことが実証されました。
                    <br><br>
                    はるのいえの企画住宅は、『
                    <span>耐震等級3</span>
                    』が
                    <span>標準仕様。</span>
                    （※条件によっては対応できない場合がございます）
                    壁量計算だけでなく、しっかりと
                    <span>構造計算</span>
                    （許容応力度計算）をして地震に対する耐力を確認しています。
                    <br><br>
                    なお、『耐震等級3相当』とは、耐震等級3と同等の性能を持ってはいるものの、住宅性能評価機関への申請をせず、正式な認定を受けていない建物のことをいいます。
                    <br><br>
                    『耐震等級3』の認定を受けた場合、地震保険の掛け金が50％に割引されるほか、フラット35の融資を受ける際に金利優遇がある、贈与税の非課税枠が加算対象となるなどのメリットも。
                    <br>
                    <br>
...
<section class="sect_8">
    <iframe width="100%" height="500" src="https://www.youtube.com/embed/ILgsuZ0jWdI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</section>
<section>9</section>
<section>10</section>
<?php get_footer(); ?>